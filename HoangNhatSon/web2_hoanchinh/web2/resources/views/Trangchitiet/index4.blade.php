	...
	<div class="module_19">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="hinh">
						<img src="{{ asset('images/image4_md19.jpg') }}" />
					</div>
				...
				<div class="col-md-6">
					<div class="chu">
						...
						<h4><?php echo $pabulum[3]['pabulum_name'] ?></h4>
						<div class="canhle">
						...
						<div class="gach"></div>
						<div class="gia">
							<h5><?php echo $pabulum[3]['pabulum_price'] ?></h5>
						</div>
						<div class="gach"></div>
						<h4><?php echo $pabulum[3]['pabulum_introduce'] ?>
						</h4>
						<div class="add">
							<h4><a href="#">ADD TO CART</a></h4>
						</div>
						<div class="nut1">
							<samp class="ban1"><?php echo $pabulum[3]['pabulum_category'] ?></samp>
							<samp><?php echo $pabulum[3]['pabulum_tags'] ?></samp>
						</div>
					...
					<h4><?php echo $pabulum[3]['pabulum_description'] ?>
					<div class="mota">
						<samp><?php echo $title[21]['title_content'] ?></samp>
					</div>
					<div class="gach"></div>
					<h4><?php echo $pabulum[3]['pabulum_reviews'] ?></h4>
				</div>
			</div>
		</div>
	</div>
